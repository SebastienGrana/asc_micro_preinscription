 ...
 *
 */
class RecrutorsFixture extends TestFixture
{
    ...
    public $fields = [
        'recrutor_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['recrutor_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
